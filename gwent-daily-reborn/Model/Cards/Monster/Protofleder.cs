...
{
    internal class Protofleder : Card
    {
        public Protofleder(int x, int y, int width, int height, float confidence, int value = 7)
            : base(x, y, width, height, confidence, "Protofleder", value)
        {
        }
